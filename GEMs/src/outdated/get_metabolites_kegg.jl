...
open("../data/inchi_stuff/inchi_valid.json", "w") do f
    JSON.print(f, valid_inchi)
end
@info "Wrote valid InChI codes: data/inchi_stuff/inchi_valid.json"

open("../data/inchi_stuff/inchi_missing.json", "w") do f
    JSON.print(f, missing_inchi)
end
@info "Wrote missing InChI codes: data/inchi_stuff/inchi_missing.json"